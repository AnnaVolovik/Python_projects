...
def project_three():
    ...
    # set the event loop for asynchronous calls to download_site method
    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)

    # open aiohttp.ClientSession() that will be shared between the calls, add all tasks
